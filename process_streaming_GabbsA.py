...
for row in reader:
    ...
    Num, Name, Type1, Type2, Total, HP, Attack, Defense, SpAttack, SpDef, Speed, Gen, Legendary = row

    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    fstring_message = f"[{Num}, {Name}, {Type1}, {Type2}, {Total}, {HP}, {Attack}, {Defense}, {SpAttack}, {SpDef}, {Speed}, {Gen}, {Legendary}]"
